...
//		System.out.println("Entree dans la boucle");
        while(!(courant.getTile().equals(tile_arrivee)))
        {
            ...
            if(courant.getTile().getPos().x % 2 == 0)
            {
                ...
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)-1][(int) (courant.getTile().getPos().y)-1]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)-1][(int) (courant.getTile().getPos().y)]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)+1][(int) (courant.getTile().getPos().y)-1]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)+1][(int) (courant.getTile().getPos().y)]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)-2][(int) (courant.getTile().getPos().y)]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)+2][(int) (courant.getTile().getPos().y)]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)][(int) (courant.getTile().getPos().y)-1]);
                tiles_base.add(grille[(int) (courant.getTile().getPos().x)][(int) (courant.getTile().getPos().y)+1]);
            }
