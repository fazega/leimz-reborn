...
public class Identification extends BasicGameState
{
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
        ...
        fond.draw();
        logo.draw(Base.sizeOfScreen_x/2-(logo.getWidth()*0.4f/2), Base.sizeOfScreen_y/2-(logo.getHeight()*0.4f/2)-200, 0.4f);
    ...
    private void test()
    {
        ...
        try {
            ...
            network = new NetworkManager(InetAddress.getByName(System.getProperty("leimz.host", "127.0.0.1")), Integer.getInteger("leimz.port", 1500));
