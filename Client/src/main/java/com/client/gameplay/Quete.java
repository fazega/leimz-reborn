        ...
        for (int i = 0; i < objectifs.size(); i++) {
            if (!objectifs.get(i).isAccompli()) {
                if (objectifs.get(i).getType().equals("endroit")) {
                    if (((float) main_player.getTile().getPos().x)
                                    == (((Vector2f) objectifs.get(i).getObjectif()).getX())
                            && ((float) main_player.getTile().getPos().y)
                                    == (((Vector2f) objectifs.get(i).getObjectif()).getY())) {
