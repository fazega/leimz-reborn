                            ...
                            public void run() {
                                while (true) {
                                        ...
                                        if (args[1].equals("deco")) {
                                            ResizableFrame frame =
                                                    PrincipalGui.getPopup(
                                                            "Le serveur vous a d̩connect̩. Motif : "
                                                                    + args[2]);
                                    ...
                                    if (state_message != null) {
                                        EntitiesManager.instance.receiveMessage(
                                                "s;" + state_message);
                                    }
                                    ...
                                    if (pnjdialog_message != null) {
                                        PrincipalGui.instance
                                                .getPnjdialogframe()
                                                .receiveMessage(pnjdialog_message);
                                    }
