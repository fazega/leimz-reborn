...
public class MainJoueur extends Joueur
{
    ...
    public void move()
    {
        ...
        {
            if(!((this.getPos_real().x>=current_chemin.getObjectif().getTile().getPos_real_barycentre().x-1)
                && (this.getPos_real().x<=current_chemin.getObjectif().getTile().getPos_real_barycentre().x+1)
                && (this.getPos_real().y>=current_chemin.getObjectif().getTile().getPos_real_barycentre().y-1)
                && (this.getPos_real().y<=current_chemin.getObjectif().getTile().getPos_real_barycentre().y+1)))
            {
