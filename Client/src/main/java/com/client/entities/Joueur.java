...
public class Joueur extends Entity
{
    ...
    public void initImgs()
    {
        ...
        pos_real_on_screen.x = (pos_real.x+MapManager.instance.getAbsolute().x)-(current_img_repos.getWidth()/2);
    ...
    {
        current_img_repos.draw((pos_real.x+MapManager.instance.getAbsolute().x)-((current_img_repos.getWidth()*scale)/2), (pos_real.y+MapManager.instance.getAbsolute().y)-(65*scale), scale);
    }
