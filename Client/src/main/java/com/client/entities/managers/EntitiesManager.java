    ...
    public void receiveMessage(String str) {
        ...
        if (temp[0].equals("afm")) {
            if (temp[1].equals("true")) {
                ...
                com.client.network.NetworkManager.instance.sendToServer(
                        "s;pos;"
                                + MainJoueur.instance.getPos_real().x
                                + ";"
                                + MainJoueur.instance.getPos_real().y
                                + ";"
                                + MainJoueur.instance.stringOrientation());
            }
        ...
        if (temp[0].equals("lo")) {
            ...
            if (temp[2].equals("pnj")) {
                ...
                Joueur j =
                        new Joueur(
                                new Personnage(temp[3], temp[4], temp[5]),
                                MapManager.instance.getEntire_map()
                                        .getGrille()[Integer.parseInt(temp[6])][
                ...
                EntitiesManager.instance
                        .getPlayers_manager()
                        .getJoueurs()
                        .get(EntitiesManager.instance.getPlayers_manager().getJoueurs().size() - 1)
                        .initImgs();
            }
            ...
            if (temp[1].equals("pnj")) {
                if (temp[3].equals("pos")) {
                    ...
                    EntitiesManager.instance
                            .getPnjs_manager()
                            .getPnj(temp[2])
                            .setOrientation(Joueur.parseStringOrientation(temp[6]));
                }
                ...
                if (temp[3].equals("pos")) {
                    ...
                    EntitiesManager.instance
                            ...
                            .getPerso()
                            .getCaracs()
                            .put(Caracteristique.VIE, Integer.parseInt(temp[4]));
                }
            }
        }
    }
