...
public class Loading extends BasicGameState
{
    ...
    public void render(GameContainer arg0, StateBasedGame arg1, Graphics arg2)
        ...
        if (filled > 0) barre.getSubImage(0, 0, filled, barre.getHeight()).draw(237*sx, 321*sy, filled*sx, barre.getHeight()*sy);
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int arg2)
        ...
        if(loadJoueurFinished && loadMapFinished)
        {
            ...
            MainJoueur.instance.setTile(MapManager.instance.getEntire_map().getGrille()[posx][posy]);
            MainJoueur.instance.setPos_real(MapManager.instance.getEntire_map().getGrille()[posx][posy].getPos_real_barycentre());
            System.out.println(posx+" "+posy);

            EntitiesManager e_m = new EntitiesManager();
            e_m.setPnjs_manager(new PNJsManager());
            e_m.setPlayers_manager(new PlayersManager(MainJoueur.instance,load_joueur.getPlayers()));
