...
& (Get-JavaTool 'javac') -encoding UTF-8 -cp "$classes;$PSScriptRoot\lib\*" -d $tests "$PSScriptRoot\tests\MapGeometryTest.java" "$PSScriptRoot\tests\NetworkQueueTest.java" "$PSScriptRoot\tests\CharacterMotionTest.java"
