...
public class Tile {
    ...
    private int pos_x_real,
            pos_y_real; // Ces positions sont les positions par rapport à l'origine (0;0)
    ...
    public boolean isPointed(int mouseX, int mouseY) {
        ...
        // Pour la démontrer, dessiner sur un schéma un losange dont les diagonales font 80 et 40
        // (UA)
